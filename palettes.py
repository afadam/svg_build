"""palettes contains predetermined colours palettes for referencing"""

plt0 = ["#283d3b", "#edddd4", "#197278", "#c44536", "#772e25"]
plt1 = ["#deffb7", "#98dfaf", "#5fb49c", "#507B92", "#495F8D", "#414288", "#4B3D7F", "#553876", "#5F336D", "#682D63"]
...
plt12 = ["#1B998B", "#044B7F", "#133E0E", "#60992D", "#8CAE68", "#5A7587", "#343128"]
